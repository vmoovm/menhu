...
function GetFormItem($ctag, $admintype='admin')
{
    ...
    {
        $innertext = "<textarea name='$fieldname' id='$fieldname' style='width:90%;height:180px'></textarea>\r\n";
    }
...
function GetFormItemValue($ctag, $fvalue, $admintype='admin', $fieldname='')
{
    ...
    {
        $innertext = "<textarea name='$fieldname' id='$fieldname' style='width:90%;height:180px'>$fvalue</textarea>\r\n";
    }
