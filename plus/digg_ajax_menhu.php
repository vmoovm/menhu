...
else
{
	...
	$digg = '<div class="bad-num clearfix fl" onclick="javascript:postDigg(\'bad\',{dede:field.id/})"><i></i><span>'.$row['badpost'].'</span></div>
			<div class="good-num clearfix fl" onclick="javascript:postDigg(\'good\',{dede:field.id/})"><i></i><span>'.$row['goodpost'].'</span></div>
			';	
