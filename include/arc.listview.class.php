...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<em class=\"pageinfo\">共 1页".$this->TotalResult."条记录</em>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<em class=\"pageinfo\">共 0页".$this->TotalResult."条记录</em>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<em class=\"pageinfo\">共 {$totalpage}页".$this->TotalResult."条</em>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class='prv' href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a>\r\n";
            $indexpage="<a class='first' href='".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<em>首页</em>\r\n";
        ...
        {
            $nextpage.="<a class='next' href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a>\r\n";
            $endpage="<a class='last' href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a>\r\n";
        }
        else
        {
            $endpage="<em>末页</em>\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<em class=\"pageinfo\">共 1 页/".$this->TotalResult." 条记录</em>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<em class=\"pageinfo\">共 0 页/".$this->TotalResult." 条记录</em>\r\n";
        }
        $maininfo = "<em class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span></em>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class='next' href='".$purl."PageNo=$prepagenum'>上一页</a>\r\n";
            $indexpage="<a class='first' href='".$purl."PageNo=1'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<em>首页</em>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class='next' href='".$purl."PageNo=$nextpagenum'>下一页</a>\r\n";
            $endpage="<a class='last' href='".$purl."PageNo=$totalpage'>末页</a>\r\n";
        }
        else
        {
            $endpage="<em>末页</em>\r\n";
